...
def defaultPage(self):
    return HttpResponse("<h2>This is Default Page</h2>")

def cardsPage(self):
    return JsonResponse({
         "item1":{'title1':'Youtube HomePage','url':'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOiSjV-n3Z2xZUlsLqNShhzOey1UrxYoT8ZlxXDS_Ffg&s=10','description':'Thanks For Seeing this Page'},
         "item2":{'title2':'Youtube ShortsPage','url':'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOiSjV-n3Z2xZUlsLqNShhzOey1UrxYoT8ZlxXDS_Ffg&s=10','description':'Thanks For Watching the shorts'},
         "item3":{'title3':'Youtube SubscrptionPage','url':'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOiSjV-n3Z2xZUlsLqNShhzOey1UrxYoT8ZlxXDS_Ffg&s=10','description':'Thanks For Subscribe'}
    })
